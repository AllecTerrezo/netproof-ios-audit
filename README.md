...
Extract the data hash from the PDF or JSON export.
Use a SHA-256 tool to hash the raw test data.
Compare the generated hash with the one embedded in the evidence to ensure the report has not been tampered with.
